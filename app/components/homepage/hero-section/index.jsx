      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
          <div className="flex flex-row">
            <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-blue-500 to-green-600"></div>
            <div className="h-[1px] w-full bg-gradient-to-r from-green-600 to-transparent"></div>
          </div>
          ...
          <div className="overflow-hidden border-t-[2px] border-blue-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Mayank Dev</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-green-400">SvelteJs</span>
                <span className="text-gray-400">{"', '"}</span>
              ...
              <div>
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-green-400">Team Collaboration</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-green-400">Critical Thinking</span>
                <span className="text-gray-400">{"'],"}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">
              ...
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="mr-2 text-white">techStack.length</span>
